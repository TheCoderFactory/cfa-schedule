class IntakesController < ApplicationController
  ...
  private
    ...
    def intake_params
      params.require(:intake).permit(:name, :term_one_start, :term_one_end, :term_two_start, :term_two_end, :term_three_start, :term_three_end, :term_four_start, :term_four_end, :color)
    end
end
